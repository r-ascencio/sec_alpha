/* 
 * vpApps
 * This is stupid i can't believe im doing this.
 * Renaming the same file, in order to do the same, just with differents names,
 * what a crap. shame on me :(
...
var dataSource = new kendo.data.DataSource({
    transport: {
        read: {
            url: Globals.baseURL + "/votacion/presidentes/electos",
            dataType: "json"
        }
    }
});
