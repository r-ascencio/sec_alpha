 ...
 * @author _r
 */
public class ReporteAlumnos5Faltantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(
                    getServletContext().getRealPath("/WEB-INF/reports/AlumnosRestantesVoto5Presidente.jasper"));
            ...
            parametros.put(
                    "Especialidad", Integer.valueOf(request.getParameter("especialidad")));
