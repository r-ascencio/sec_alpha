 ...
 * @author _r
 */
public class ReporteEstadisticasPresidenteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(
                    getServletContext().getRealPath("/WEB-INF/reports/ReportePresidenteEstadisticas.jasper")
                    );
