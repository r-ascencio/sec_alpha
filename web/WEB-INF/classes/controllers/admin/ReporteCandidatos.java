...
/**
 * /admin/reportes/Candidatos
 *
 * @author _r
 */
public class ReporteCandidatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(
                    getServletContext().getRealPath("/WEB-INF/reports/ReporteCandidatoEstadisticas.jasper"));
